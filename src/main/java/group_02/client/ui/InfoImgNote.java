 ...
 * @author Admin
 */
public class InfoImgNote extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoImgNote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
