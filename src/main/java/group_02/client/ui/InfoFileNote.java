 ...
 * @author Admin
 */
public class InfoFileNote extends javax.swing.JFrame {

    /**
     * Creates new form ListNote
     */
    public InfoFileNote(String id) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Infomation Note");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setText("NameNote");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setText("TypeNote");
        ...
        jLabel3.setText("There is no preview for this file. Please download");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoFileNote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new InfoFileNote().setVisible(true);
            }
        });
    }
