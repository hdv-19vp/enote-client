 ...
 * @author Admin
 */
public class InfoTextNote extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoTextNote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
